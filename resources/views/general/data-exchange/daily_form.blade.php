        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <!-- search form -->
                    <form action="{{ route('general.get-daily-form') }}" method="GET">
                        <!-- @csrf -->
                        <div class="row">
                            ...
                            <div class="col-auto">
                                ...
                                <a class="btn btn-danger btn-sm" href="{{ route( 'general.exchange-index', [ 'form' => $form_id, 'elements' => $elements, 'month' => $month ] ) }}">{{ $metki->where('id_column','Назад')->first() ? $metki->where('id_column','Назад')->first()->only('mark_name')['mark_name'] : 'Назад' }}</a>
                            ...
                            <tbody>
                                ...
                                @foreach($forms as $form)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" data-names="present" name="checking_present[]" class="object-day-value1 gr-obj-class"
                                                <?php if($form->present == 1) echo 'checked="checked"'; ?> data-name="check_{{ $form->gvk_object_id }}" value="{{ $form->present }}" data-id="{{ $form->id }}"
                                            >
                                        </td>
                                        <td>
                                            <input type="checkbox" data-names="morning" name="checking_morning[]" class="object-day-value1 gr-obj-class"
                                                <?php if($form->morning == 1) echo 'checked="checked"'; ?> data-name="check_{{ $form->gvk_object_id }}" value="{{ $form->morning }}" data-id="{{ $form->id }}"
                                            >
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <form action="{{ route('general.post-delete-object-from-daily', ['id' => $form->id ]) }}" method="POST">
                                                @csrf
