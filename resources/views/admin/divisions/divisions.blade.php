...
{{--                        </div>--}}
                ...
                <div class="col-auto">
                    <ul class="list-inline small">
                        <li class="list-inline-item"><a href="{{route('admin.divisions.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Добавить</a></li>
                    </ul>
                </div>
            </div>
                ...
                <table id="" class="table table-striped small reestr-tables">
                    ...
                    @foreach($divisions as $key => $division)
                        <tr>
                            ...
                            <td>
                                <button onclick="window.location.href='{{route('admin.divisions.edit',$division->id)}}'"  type="button" class="btn btn-sm btn-outline-info waves-effect"><i class="fas fa-pencil-alt"></i></button>
