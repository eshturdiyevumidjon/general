                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr class="bir">
                                    ...
                                    <th>{{ trans('messages.Number auther') }}</th>
                                    <th>{{ trans('messages.Cadaster number') }}</th>
                                    <th>{{ trans('messages.Mineralization') }}</th>
                                    <th>{{ trans('messages.Wells type') }}</th>
                            ...
                            <tbody>
                                @foreach($allDatas as $data)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="object[]" class="gr-obj-class" data-status="0" data-name="{{ $data['number_auther'] }}" value="{{ $data['number_auther'] }}">
                                        </td>
