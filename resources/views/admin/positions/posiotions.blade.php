            ...
            <div class="row justify-content-between">
                ...
                <div class="col-auto">
                    <ul class="list-inline small">
                        ...
                        <li class="list-inline-item"><a href="{{route('admin.positions.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Добавить</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    @foreach($positions as $key => $position)
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="window.location.href='{{route('admin.positions.edit',$position->id)}}'"  type="button" class="btn btn-sm btn-outline-info waves-effect"><i class="fas fa-pencil-alt"></i></button>
