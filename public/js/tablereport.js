...
this.getitemparent();
    ...
    methods: {
        gettable:function () {
            ...
            axios.get(homeurl+'/minvodxoz/page/reports/elements/'+parent_id+'?json')
        ...
        getitemsx:function () {
            ...
            axios.get(homeurl+'/minvodxoz/page/templates/jsonx?id='+selected_template)
                .then(function (response) {
            ...
            switch (n[0]) {
                case "SUM":
                    ...
                    $.each(arr, function (index, value) {
                       ...
                       // var rr = value.split(':');
                        ...
                        rr = _this.rows[keytr][1][value].name;
                        if(rr !="undefined"){
                            summ += parseInt(rr);
                        }
                ...
                case "Average":
                    ...
                    $.each(arr, function (index, value) {
                     ...
                     var   rr = _this.rows[keytr][1][value].name;
...
var alls = n[0];
                    ...
                    $.each(arr, function (index, value) {
                        ...
                        alls =  _this.rows[keytr][1][value].name;
